...
- `dev=` can output multiple formats like `=c('png','jpeg')` and will go to fig path if set but looks like first is embedded.  If chunk cached might go there too. Options include `tikz` (which could be nice)...
